...
NMilitary = {
	...
	--TODO:set above to zero if we do something with sailors
...
NFrontend = {
	CAMERA_LOOKAT_X = 1858.0, 						-- Rotation point in main menu
	CAMERA_LOOKAT_Y = 0.0,
	CAMERA_LOOKAT_Z = 1219.0,
	CAMERA_LOOKAT_SETTINGS_X = 1858.0, 				-- Rotation point in settings
	CAMERA_LOOKAT_SETTINGS_Y = 0.0,					-- Y is height
	CAMERA_LOOKAT_SETTINGS_Z = 919.0,
	CAMERA_START_X = 1858.0,						-- Initial position in main menu
	CAMERA_START_Y = 900,							-- Y is height
	CAMERA_START_Z = 1100.0,
	CAMERA_END_X = 1858.0,							-- Move to position in main menu
	CAMERA_END_Y = 800.0,
	CAMERA_END_Z = 1100.0,
	...
	FRONTEND_POS_X = 1858.0,
	FRONTEND_POS_Y = 700.0,
	FRONTEND_POS_Z = 900.0,
	FRONTEND_LOOK_X = 1858.0,
	FRONTEND_LOOK_Y = 0.0,
	FRONTEND_LOOK_Z = 919.0,
...
NReligion = {
	...
	MAX_RELIGIOUS_CENTER_SPREAD_DISTANCE = 225.0,				-- When spreading the religion to other provinces the distance wont exceed this number
